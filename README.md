...
git clone https://github.com/MAS234/notchatbot.git
...
Crea un archivo .env en la raíz del proyecto y proporciona las credenciales para Neon y otras configuraciones necesarias.
